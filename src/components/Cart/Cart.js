    ...
    <div>
      <div className="container  mt-5">
        ...
        <div className="my-info mt-8 bg-slate-300 ml-2 flex justify-center items-center gap-16  md:gap-4 lg:gap-6 h-20 rounded-lg">
          <div className="city">
            <h4 className="font-medium text-lg md:text-md lg:text-2xl">Dhaka</h4>
          ...
          <div className="club">
            <h4 className="font-medium text-lg md:text-md lg:text-2xl text-center">
              Working at
            </h4>
            <h3 className=" text-sm ">Health-Club</h3>
          </div>
        </div>

        <h3 className="mt-6 text-2xl font-medium ml-2 text-left">Add A Break</h3>
        ...
        <h3 className="mt-6 mb-4 text-2xl font-medium ml-2 text-left">Exercise Details</h3>
        ...
        <div className="flex items-center justify-center">
          <button
            className="bg-orange-400 text-white px-16 mt-3  py-2 rounded-xl"
            onClick={notify}
          >
            Task Completed!
          </button>
